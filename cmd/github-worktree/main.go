...
func run(ctx context.Context, args []string) error {
	...
	fs := flag.NewFlagSet("github-worktree seed", flag.ContinueOnError)
...
func usage() error {
	return fmt.Errorf("usage: github-worktree seed --repository <owner/name> --sha <40-char-sha> --destination <path> [--role-ref <branch>] [--object-root <path>] [--token-env <name>]")
}
