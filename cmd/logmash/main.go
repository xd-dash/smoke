...
//
// Stdout is included by default and implies an attached runtime: output is
// visible, the shell waits, and Ctrl+C stops the composition. With stdout
// disabled, Logmash is unattended and starts another process from the same
// Smoke executable unless --attached explicitly keeps that runtime attached.
